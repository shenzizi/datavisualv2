...
var width = 150, //150,200
    ...
    //.style("border","1px solid green")
     var ordinal = d3.scale.ordinal()
                   ...
                   .range([ "rgb(111, 206, 29)", "rgb(174, 1, 141)", "rgb(82, 84, 163)", "rgb(214, 39, 40)", "rgb(241, 166, 31)","rgb(18,184,149)"]);
...
var color = d3.scale.ordinal()
    //.range(["#996bc3", "#386ca5", "#5dc74c", "#e9c71f", "#ea762f", "#f495a3"]);
    .range(["#6fce1d", "#ae018d", "#5254a3", "#d62728", "#f1a61f", "#12b895"]);
...
var svg = d3.select("#barlinechart01")
  ...
  svg.append("g") 
     ...
     .style("text-anchor", "end") 
     .text("10秒廣告價")
     .attr("transform", "translate(10," + textposition + ")");
...
var color = d3.scale.ordinal()
  ...
  var circlepadding=width/data.length/2-3; 

   svg.selectAll("circle")
    .data(data)
    .enter().append("circle")
    .style("opacity",0)
    .attr("fill", "#bcbddc") //#3895a3
    .attr("r", 8)
